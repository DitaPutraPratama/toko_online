<div class="container-fluid">
	<button type="button" class="btn btn-primary btn-sm mb-3" data-toggle="modal" data-target="#tambah_barang">
	...
	<table class="table table-hover table-striped">
		...
		foreach ($barang as $brg) :; ?>
			<tr>
				...
				<td><?php echo anchor('admin/data_barang/detail/' . $brg->id_brg, '<div class="btn btn-success btn-sm"><i class="fa fa-search-plus"></i></div>'); ?>
				</td>
			...
			<div class="modal-body">
				<form action="<?php echo base_url() . 'admin/data_barang/tambah_aksi' ?>" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<select name="kategori" id="" class="form-control" aria-placeholder="Isi Kategori">
